...
const BENEFITS: Benefit[] = [
  {
    heading: 'Доставка по всій країні',
    text: 'Безкоштовно від 3 000 ₴, відправлення в день замовлення',
    icon: (
      <>
  ...
  {
    heading: 'Обмін і повернення 30 днів',
    text: 'Без зайвих запитань, у будь-якому магазині мережі',
    icon: (
      <>
  ...
  {
    heading: 'Подарункове пакування',
    text: 'Фірмова коробка та листівка до кожного замовлення',
    icon: (
      <>
  ...
  {
    heading: 'Підтримка щодня',
    text: 'Допоможемо з вибором, розміром та оформленням замовлення',
    icon: (
      <>
