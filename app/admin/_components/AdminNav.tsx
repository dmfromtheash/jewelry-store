...
const NAV_ITEMS: readonly AdminNavItem[] = [
  ...
  { href: '/admin/readiness', label: 'Готовность' },
  { href: '/admin/seo', label: 'SEO' },
  { href: '/admin/reviews', label: 'Отзывы' },
  { href: '/admin/product-questions', label: 'Вопросы о товаре' },
  { href: '/admin/availability-interests', label: 'Ожидание наличия' },
  { href: '/admin/help', label: 'Помощь' },
